...
//TODO
llvm::Type* IRGenerator::GetType(Type* type, llvm::LLVMContext *context) {
  if(type == Type::intType) {
    ...
    llvm::Type* e = GetType(dynamic_cast<ArrayType*>(type)->GetElemType(), context);
    return llvm::ArrayType::get(e, dynamic_cast<ArrayType*>(type)->GetElemCount());
  }
  else{
    return NULL;
  }
